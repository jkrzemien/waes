...
public interface LeftOperandsRepository extends CrudRepository<LeftOperand, Long> {
   ...
   */
  List<LeftOperand> findTopByOperationIdOrderByCreatedDesc(@Param("operationId") Long operationId);
